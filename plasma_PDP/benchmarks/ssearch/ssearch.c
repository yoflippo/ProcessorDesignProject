...
int _main_ssearch(int argc ,char *argv[]);
...
#endif
{
    ...
    printf("Executing benchmark SSEARCH...\n");
    t1 = get_ticks();
    _main_ssearch(1,args1);
    t2 = get_ticks();
    printf("----------------------------------------------------------\n");
    printf("SSEARCH took %'.6lf million clock cycles\n",(t2-t1)/1000000.0);
    printf("----------------------------------------------------------\n");
#ifdef ALL_BENCHMARKS
...
"worth But trust me on the sunscreen"
      ...
      if (found != 49677)
    	  printf("ERROR: Strings found %d times, expected 49677 times\n\n",found);
      else
    	  printf("CORRECT!\n\n");
      return 0;
}
